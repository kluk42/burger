...
import { InputNames, ValidationRules, Validity, ValidationMessages, ValidationRuleSet } from './types';
                ...
                {!isLoading ?
                    <>
                        ...
                        <form className="Auth__form" onSubmit={submitHandler}>
                            ...
                            />
                            <Button theme={Theme.Success} disabled={!isFormValid} isSubmit>Submit</Button>
                        </form>
                    </>
                    :
                    <Spinner/>
